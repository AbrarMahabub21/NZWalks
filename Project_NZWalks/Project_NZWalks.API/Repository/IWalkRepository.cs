...
namespace Project_NZWalks.API.Repository
{
    public interface IWalkRepository
    {
        ...
        public Task<List<Walk>> GetWalkAsync(string?filterOn = null, string?filterQuery = null, string? sortBy=null, bool isAscending=true, int pageNumber = 1, int pageSize = 10);
